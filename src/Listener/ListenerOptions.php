...
class ListenerOptions extends AbstractOptions
{
     ...
     * @var bool
     */
    protected $themeMapCacheEnabled = false;

    /**
     * @var string
     */
    protected $themeMapCacheKey;
     ...
     * @return bool
     */
    public function getThemeMapCacheEnabled()
    {
        return $this->themeMapCacheEnabled;
    }
     ...
     * @return ListenerOptions
     */
    public function setThemeMapCacheEnabled($enabled)
    {
        $this->themeMapCacheEnabled = (bool) $enabled;
        return $this;
    }
     ...
     * @return string
     */
    public function getThemeMapCacheKey()
    {
        return (string) $this->themeMapCacheKey;
    }

    /**
     * Set key used to create the cache file name
     *
     * @param  string $themeMapCacheKey the value to be set
     * @return ListenerOptions
     */
    public function setThemeMapCacheKey($themeMapCacheKey)
    {
        $this->themeMapCacheKey = $themeMapCacheKey;
        return $this;
    }
    ...
    {
        if ($this->getThemeMapCacheKey()) {
            return $this->getCacheDir() . '/theme-classmap-cache.' . $this->getThemeMapCacheKey() . '.php';
        }

        return $this->getCacheDir() . '/theme-classmap-cache.php';
    }
